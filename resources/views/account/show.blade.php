                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::select(
                                        'transaction_type',
                                        ['' => __('messages.all'), 'credit' => __('account.debit'), 'debit' => __('account.credit')],
                                        '',
                                        ['class' => 'form-control'],
                                    ) !!}
                                </div>
        ...
        $(document).ready(function() {
            ...
            account_book = $('#account_book').DataTable({
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    for (var r in data) {
                        footer_total_debit += $(data[r].credit).data('orig-value') ? parseFloat($(data[
                            r].credit).data('orig-value')) : 0;
                        footer_total_credit += $(data[r].debit).data('orig-value') ? parseFloat($(data[
                            r].debit).data('orig-value')) : 0;
                    }
